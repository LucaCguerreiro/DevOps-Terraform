resource "aws_subnet" "devops_subnet_private_1a" {
...
resource "aws_route_table_association" "eks_rtb_assoc_priv_1a" {
  subnet_id      = aws_subnet.devops_subnet_private_1a.id
  route_table_id = aws_route_table.eks_private_route_table_1a.id
}

resource "aws_route_table_association" "eks_rtb_assoc_1b_priv_1b" {
  subnet_id      = aws_subnet.devops_subnet_private_1b.id
